...
default_args={
    "owner": "njganeshv@gmail.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2023-10-23", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "njganeshv@gmail.com": "mailto:njganeshv@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clo2xa1n2002e01nuu09cv4a6/cloud-ide/clo2xap5z002f01numhqoue1r/clo2xapf7013401md39t6v4f7",
    },
)
